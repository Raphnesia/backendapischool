...
use App\Filament\Resources\EkstrakurikulerSettingsResource\Pages;
use App\Filament\Resources\EkstrakurikulerSettingsResource\RelationManagers;
...
class EkstrakurikulerSettingsResource extends Resource
{
    protected static ?string $model = EkstrakurikulerSettings::class;

    protected static ?string $navigationIcon = 'heroicon-o-academic-cap';

    protected static ?string $navigationGroup = 'Profil Sekolah';

    protected static ?string $navigationLabel = 'Pengaturan Ekstrakurikuler';
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('title')
                    ...
                    ->required()
                    ->maxLength(255)
                    ->placeholder('Masukkan judul halaman ekstrakurikuler'),
                ...
                Forms\Components\Select::make('subtitle_panel_bg_color')
                    ...
                    ->default('bg-gradient-to-r from-blue-700 to-blue-900')
                    ->required(),
    ...
    {
        return [
            'index' => Pages\ListEkstrakurikulerSettings::route('/'),
            'create' => Pages\CreateEkstrakurikulerSettings::route('/create'),
            'edit' => Pages\EditEkstrakurikulerSettings::route('/{record}/edit'),
        ];
    }
}
