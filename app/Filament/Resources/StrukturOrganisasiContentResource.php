...
use App\Filament\Resources\StrukturOrganisasiContentResource\Pages;
use App\Filament\Resources\StrukturOrganisasiContentResource\RelationManagers;
...
class StrukturOrganisasiContentResource extends Resource
{
    protected static ?string $model = StrukturOrganisasiContent::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationGroup = 'Profil Sekolah';

    protected static ?string $navigationLabel = 'Struktur Organisasi Content';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Repeater::make('bidang_structure')
                    ...
                    ->schema([
                        Forms\Components\TextInput::make('bidang_name')
                            ...
                            ->required()
                            ->placeholder('Contoh: Bagian Administrasi, Bagian Kurikulum, dll'),
                        ...
                        Forms\Components\Repeater::make('members')
                            ...
                            ->schema([
                                ...
                                Forms\Components\TextInput::make('position')
                                    ...
                                    ->placeholder('Contoh: Kepala Bagian, Anggota, dll'),
                            ])
                            ->defaultItems(1)
                            ->reorderable()
                            ->collapsible()
                ...
                Forms\Components\Select::make('display_type')
                    ...
                    ->default('list')
                    ->required()
                    ->helperText('Pilih tipe tampilan untuk struktur organisasi')
                    ->visible(fn (Forms\Get $get): bool => $get('use_list_disc') === true),
        ...
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\TernaryFilter::make('use_list_disc')
                    ->label('Menggunakan Struktur Bidang'),
    ...
    {
        return [
            'index' => Pages\ListStrukturOrganisasiContents::route('/'),
            'create' => Pages\CreateStrukturOrganisasiContent::route('/create'),
            'edit' => Pages\EditStrukturOrganisasiContent::route('/{record}/edit'),
        ];
    }
}
